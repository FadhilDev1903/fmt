            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('set_periode_create') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="periode_name">Periode Name</label>
                                        <input type="text" class="form-control" id="periode_name"
                                            placeholder="Periode Name" name="periode_name">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile">Upload GSNR file</label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-orange">
                                <h3 class="card-title text-white">Shoplist</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <table id="dataShopList"
                ...
                <div class="modal fade" id="modal-shoplist-detail">
                    <div class="modal-dialog modal-lg">
                        <form action="{{ route('set_periode_update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="shop_name"
                                                    id="shop_name" placeholder="Shop Name" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                ...
                <div class="modal fade" id="modal-shoplist-show">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Shoplist Detail</h4>
