            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <!-- form start -->
                        <form action="{{ isset($getProject) ? route('project_update') : route('project_add') }}"
                            id="form-project" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card">
                                <div class="card-header bg-orange">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 float-right">
                                            ...
                                            <a href="{{ route('project') }}" class="btn btn-danger float-right"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="project_name"
                                                    ...
                                                    @error('project_name') is-invalid @enderror required maxlength="12">
...
@endisset
                ...
                <!-- /.row -->
                <!-- modal -->
                <div class="modal fade" id="modal-user-project">
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                onkeyup="this.value = this.value.replace(/[^0-9,]/g, '');"
                                                onchange="this.value = formatRupiah(this.value);" name="sallary"
                                                id="sallary" placeholder="Sallary">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-danger" id="btn-delete-user-project"
                                    style="display: none">Delete</button>
                                <button type="button" class="btn btn-primary" id="btn-add-user-project">Save</button>
                            </div>
                        </div>
                        {{-- </form> --}}
                        <!-- /.modal-content -->
